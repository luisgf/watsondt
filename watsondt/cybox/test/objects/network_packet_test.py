...
class TestEthernetInterface(EntityTestCase, unittest.TestCase):
    ...
    _full_dict = {
        'ethernet_header': {
            'destination_mac_addr': {'address_value': "00:11:22:33:44:55",
                                        'category': Address.CAT_MAC,
                                        'xsi:type': 'AddressObjectType'},
            'source_mac_addr': {'address_value': "aa:bb:cc:dd:ee:ff",
                                'category': Address.CAT_MAC,
                                'xsi:type': 'AddressObjectType'},
            'type_or_length': {'length': "1abf",
                                'internet_layer_type': "IPv4(0x0800)"},
            'checksum': "fa10",
        }
    }
...
class TestARP(EntityTestCase, unittest.TestCase):
    ...
    _full_dict = {
        'hardware_addr_type': "Ethernet(1)",
        'proto_addr_type': "IPv4(0x0800)",
        'hardware_addr_size': "6",
        'proto_addr_size': "4",
        'op_type': "ARP request(1)",
        'sender_hardware_addr': {'address_value': "01:12:23:34:45:56",
                                    'category': Address.CAT_MAC,
                                    'xsi:type': 'AddressObjectType'},
        'sender_protocol_addr': {'address_value': "1.2.3.4",
                                    'category': Address.CAT_IPV4,
                                    'xsi:type': 'AddressObjectType'},
        'recip_hardware_addr': {'address_value': "a0:b0:c0:d0:e0:f0",
                                'category': Address.CAT_MAC,
                                'xsi:type': 'AddressObjectType'},
        'recip_protocol_addr': {'address_value': "9.10.11.12",
                                'category': Address.CAT_IPV4,
                                'xsi:type': 'AddressObjectType'},
    }
...
class TestNDPLinkAddr(EntityTestCase, unittest.TestCase):
    ...
    _full_dict = {
        'length': 14,
        'link_layer_mac_addr': {'address_value': "80:70:60:50:40:30",
                                'category': Address.CAT_MAC,
                                'xsi:type': 'AddressObjectType'},
    }
...
class TestNDPPrefixInfo(EntityTestCase, unittest.TestCase):
    ...
    _full_dict = {
        ...
        'prefix': {
            'ipv6_addr': {'address_value': "2001:db8::ff00:42:832",
                            'category': Address.CAT_IPV6,
                            'xsi:type': 'AddressObjectType'},
            'ip_addr_prefix': {'address_value': "2001:0db8:85a3",
                                    'category': Address.CAT_IPV6,
                                    'xsi:type': 'AddressObjectType'},
        }
    }
...
class TestNDP(EntityTestCase, unittest.TestCase):
    ...
    _full_dict = {
        ...
        'neighbor_solicitation': {
            'target_ipv6_addr': {'address_value': "2001:db99::ff00:832",
                                    'category': Address.CAT_IPV6,
                                    'xsi:type': 'AddressObjectType'},
        ...
        'neighbor_advertisement': {
            ...
            'override_flag': True,
            'target_ipv6_addr': {'address_value': "::1",
                                    'category': Address.CAT_IPV6,
                                    'xsi:type': 'AddressObjectType'},
            'options': {'target_link_addr': {'length': 48}},
        },
        'redirect': {
            'target_ipv6_addr': {'address_value': "2001::1",
                                    'category': Address.CAT_IPV6,
                                    'xsi:type': 'AddressObjectType'},
            'dest_ipv6_addr': {'address_value': "2001::dd88:1",
                                'category': Address.CAT_IPV6,
                                'xsi:type': 'AddressObjectType'},
            'options': {
...
class TestIPv4Packet(EntityTestCase, unittest.TestCase):
    ...
    _full_dict = {
        'ipv4_header': {
            ...
            'flags': {
                'reserved': 0,
                'do_not_fragment': "donotfragment(1)",
                'more_fragments': "lastfragment(0)",
            },
            'fragment_offset': "7c",
            'ttl': "fa",
            'protocol': "TPC(6)",
            'checksum': "0fca",
            'src_ipv4_addr': {'address_value': "172.16.21.50",
                            'category': Address.CAT_IPV4,
                            'xsi:type': 'AddressObjectType'},
            'dest_ipv4_addr': {'address_value': "172.16.21.1",
                            'category': Address.CAT_IPV4,
                            'xsi:type': 'AddressObjectType'},
            'option': [
                {'copy_flag': "donotcopy(0)", 'class': "control(0)"},
                {'class': "reserved(3)", 'option': "security(2)"},
            ]
        },
        'data': "04fc3a3f67e4",
    }
    ...
    _full_dict = {
        ...
        'error_msg': {
            ...
            'redirect_message': {
                ...
                'ip_address': {'address_value': "10.3.4.5",
                                'category': Address.CAT_IPV4,
                                'xsi:type': 'AddressObjectType'},
            },
            'time_exceeded': {
            ...
            'error_msg_content': {
                'ip_header': {'ip_version': "IPv4(4)"},
                'first_eight_bytes': "0123456789abcdef",
            },
        },
        'info_msg': {
            'echo_reply': {
            ...
            'address_mask_request': {
                ...
                'address_mask': {'address_value': "255.255.0.0",
                                    'category': Address.CAT_IPV4_NETMASK,
                                    'xsi:type': 'AddressObjectType'},
            },
            'address_mask_reply': {
                'address_mask_reply': True,
                'address_mask': {'address_value': "255.255.255.0",
                                    'category': Address.CAT_IPV4_NETMASK,
                                    'xsi:type': 'AddressObjectType'},
            },
            'info_msg_content': {
                'identifier': "f198",
                'sequence_number': "1dc9",
            },
        },
        'traceroute': {
            ...
            'identifier': "1234",
            'outbound_hop_count': "001f",
            'return_hop_count': "001c",
            'output_link_speed': "000f42f0",
            'output_link_mtu': "00000000",
        },
    }
...
class TestIPv6(EntityTestCase, unittest.TestCase):
    ...
    _full_dict = {
        'ipv6_header': {
            ...
            'next_header': "TCP(6)",
            'ttl': 128,
            'src_ipv6_addr': {'address_value': "2001:85a3::8a2e:370:734",
                            'category': Address.CAT_IPV6,
                            'xsi:type': 'AddressObjectType'},
            'dest_ipv6_addr': {'address_value': "2001:3a58::8a2e:370:734",
                            'category': Address.CAT_IPV6,
                            'xsi:type': 'AddressObjectType'},
        },
        'ext_headers': [
            {
                'hop_by_hop_options': {
                    'next_header': "IPv6routingheader(43)",
                    'header_ext_len': "1f",
                    'option_data': [
                        {
                            'option_type': {
                                'do_not_recogn_action': "skipoption(00)",
                                'packet_change': "change(1)",
                                'option_byte': "04",
                            },
                            'option_data_len': "0100",
                            'pad1': {'octet': "00"},
                            'padn': {'octet': "01",
                        ...
                        {
                            'option_type': {'option_byte': "02"},
                            'option_data_len': "007f",
                            'pad1': {'octet': "00"},
                        },
                    ]
                },
            ...
            },
            {
                'fragment': {
                    'fragment_header': {
                        'next_header': "IPv6routingheader(43)",
                        'fragment_offset': "01fb",
                        'm_flag': "lastfragment(0)",
                        'identification': "aa",
                    },
                    'fragment': "bc27648fbace"
                },
            },
            {
                'destination_options': [
            ...
            },
            {
                'authentication_header': {
                    'next_header': "IPv6routingheader(43)",
                    'header_ext_len': "1f",
                    'security_parameters_index': "deadbeef",
                    'sequence_number': "feedbacc",
                    'authentication_data': "abcd0123fedc4567",
                },
            },
            {
...
class TestICMPv6(EntityTestCase, unittest.TestCase):
    ...
    _full_dict = {
        ...
        'error_msg': {
            ...
            'invoking_packet': "0f1e2d3c4b5a9687",
        },
        'info_msg': {
            'echo_request': {
                'echo_request': True,
...
class TestTCP(EntityTestCase, unittest.TestCase):
    ...
    _full_dict = {
        ...
        'data': {
            'data_format': "Text",
            'data_size': {"value": "100", 'units': "Kilobytes"},
            'data_segment': "A long, long time ago...",
            'offset': 100,
            'search_distance': 200,
            'search_within': 40,
        }
...
class TestUDP(EntityTestCase, unittest.TestCase):
    ...
    _full_dict = {
        ...
        'data': {
            'data_format': "Hex",
            'data_size': {"value": "16", 'units': "Bytes"},
            'data_segment': "000102030405060708090a0b0c0d0e0f",
        }
    }
