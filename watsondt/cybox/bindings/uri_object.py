...
class URIObjectType(cybox_common.ObjectPropertiesType):
    ...
    def validate_AnyURIObjectPropertyType(self, value):
        # Validate type cybox_common.AnyURIObjectPropertyType, a restriction on None.
        pass
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, lwrite, level, namespace_='URIObj:', name_='URIObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        self.exportAttributes(lwrite, level, already_processed, namespace_, name_='URIObjectType')
        if self.hasContent_():
            lwrite('>%s' % (eol_, ))
    ...
    def exportChildren(self, lwrite, level, namespace_='URIObj:', name_='URIObjectType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Value is not None:
            self.Value.export(lwrite, level, 'URIObj:', name_='Value', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Value':
            obj_ = cybox_common.AnyURIObjectPropertyType.factory()
            obj_.build(child_)
            self.set_Value(obj_)
...
def parseString(inString):
    ...
    doc = None
#    sys.stdout.write('<?xml version="1.0" ?>\n')
#    rootObj.export(sys.stdout.write, 0, name_="URI",
#        namespacedef_='')
    return rootObj
