...
class Layer4ProtocolType(cybox_common.BaseObjectPropertyType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, lwrite, level, namespace_='PortObj:', name_='Layer4ProtocolType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PortObjectType(cybox_common.ObjectPropertiesType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, lwrite, level, namespace_='PortObj:', name_='PortObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        lwrite('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(lwrite, level, already_processed, namespace_, name_='PortObjectType')
        if self.hasContent_():
            lwrite('>%s' % (eol_, ))
            self.exportChildren(lwrite, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(lwrite, level, pretty_print)
            ...
            lwrite('/>%s' % (eol_, ))
    def exportAttributes(self, lwrite, level, already_processed, namespace_='PortObj:', name_='PortObjectType'):
        super(PortObjectType, self).exportAttributes(lwrite, level, already_processed, namespace_, name_='PortObjectType')
    def exportChildren(self, lwrite, level, namespace_='PortObj:', name_='PortObjectType', fromsubclass_=False, pretty_print=True):
        super(PortObjectType, self).exportChildren(lwrite, level, 'PortObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Port_Value is not None:
            self.Port_Value.export(lwrite, level, 'PortObj:', name_='Port_Value', pretty_print=pretty_print)
...
def parseString(inString):
    ...
    doc = None
#    sys.stdout.write('<?xml version="1.0" ?>\n')
#    rootObj.export(sys.stdout.write, 0, name_="Port",
#        namespacedef_='')
    return rootObj
