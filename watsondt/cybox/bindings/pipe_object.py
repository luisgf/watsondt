...
class PipeObjectType(cybox_common.ObjectPropertiesType):
    ...
    def __init__(self, object_reference=None, Custom_Properties=None, xsi_type=None, named=None, Name=None):
        super(PipeObjectType, self).__init__(object_reference, Custom_Properties, xsi_type )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, lwrite, level, namespace_='PipeObj:', name_='PipeObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        self.exportAttributes(lwrite, level, already_processed, namespace_, name_='PipeObjectType')
        if self.hasContent_():
            lwrite('>%s' % (eol_, ))
...
def parseString(inString):
    ...
    doc = None
#    sys.stdout.write('<?xml version="1.0" ?>\n')
#    rootObj.export(sys.stdout.write, 0, name_="Pipe",
#        namespacedef_='')
    return rootObj
